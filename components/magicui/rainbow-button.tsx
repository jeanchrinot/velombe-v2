...
>(({ children, className, ...props }, ref) => {
  return (
    ...
    //     // before styles
    //     "before:absolute before:bottom-[-20%] before:left-1/2 before:z-0 before:h-1/5 before:w-3/5 before:-translate-x-1/2 before:animate-rainbow before:bg-[linear-gradient(90deg,var(--color-1),var(--color-5),var(--color-3),var(--color-4),var(--color-2))] before:[filter:blur(calc(0.8*1rem))]",
    //     // light mode background with base-color
    //     "bg-[linear-gradient(var(--base-color),var(--base-color)),linear-gradient(var(--base-color)_50%,rgba(37,99,235,0.6)_80%,rgba(37,99,235,0)),linear-gradient(90deg,var(--color-1),var(--color-5),var(--color-3),var(--color-4),var(--color-2))]",
    //     // dark mode background (same base-color or you can customize)
    //     "dark:bg-[linear-gradient(var(--base-color),var(--base-color)),linear-gradient(var(--base-color)_50%,rgba(37,99,235,0.6)_80%,rgba(0,0,0,0)),linear-gradient(90deg,var(--color-1),var(--color-5),var(--color-3),var(--color-4),var(--color-2))]",
    //     className
    //   )}
    //   {...props}
    // >
